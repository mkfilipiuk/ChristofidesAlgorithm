def tsp(data, norm_function):
    # build a graph
    G = build_graph(data, norm_function)
    # print("Graph: ", G)
...
def get_length(x1, y1, x2, y2, norm_function):
    return norm_function(x1, y1, x2, y2)


def build_graph(data, norm_function):
    graph = {}
        ...
        for another_point in range(len(data)):
            if this != another_point:
                ...
                graph[this][another_point] = get_length(data[this][0], data[this][1], data[another_point][0],
                                                        data[another_point][1], norm_function)
